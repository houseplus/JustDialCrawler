	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < 50; i++) {
			...
			try {
				...
				List<Electrician> listElectricians = new ArrayList<>();

				
				
				//driver.get("https://www.justdial.com/Bangalore/Electricians/nct-10184166/page-" + i);
				...
				do {
					...
					{
						System.out.println("oldnumRecord     "+oldnumRecord+"totalNumberOfrecords"+totalNumberOfrecords);
				...
				for (int j = 0; j < 1000; j++) {
					...
					List<WebElement> nameElement = driver
							.findElements(By.xpath("//*[@id='bcard" + j + "']/div[1]/section/div[1]/h4/span/a"));
					...
					System.out.println("The record number "+j+"    "+name+" "+address+"   "+numvotes+"     "+phonenum);
					...
					if (null != name && null != phonenum) {
						...
						Electrician electrician = new Electrician(name, address, numvotes, phonenum);
